...
void gpioSetup()
{
	...
	GPIOA->CRH |= GPIO_CRH_CNF9_1 | GPIO_CRH_MODE9_0  //PA9 (uart1 tx) output_max 10 MHz push-pull
		| GPIO_CRH_CNF11_1 | GPIO_CRH_MODE11_0 | GPIO_CRH_MODE11_1;  //PA11 (TIM1_CH4) output push-pull
	...
	GPIOB->CRH |= GPIO_CRH_CNF13_1 | GPIO_CRH_MODE13_0 | GPIO_CRH_MODE13_1 //PB13 (TIM1_CH1N) output push-pull
		| GPIO_CRH_CNF14_1 | GPIO_CRH_MODE14_0 | GPIO_CRH_MODE14_1	 //PB14 (TIM1_CH2N) output push-pull
		| GPIO_CRH_CNF15_1 | GPIO_CRH_MODE15_0 | GPIO_CRH_MODE15_1;	 //PB15 (TIM1_CH3N) output push-pull
